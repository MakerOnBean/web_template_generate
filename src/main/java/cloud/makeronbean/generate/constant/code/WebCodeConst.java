...
public enum WebCodeConst implements CodeTemplate {
    ...
    GLOBAL_EXCEPTION_HANDLER("common/exception", "GlobalExceptionHandler.java", "%s\n\n" +
            "import " + PomResolver.getInstance().getGroupId() + ".common.result.R;\n" +
            "import " + PomResolver.getInstance().getGroupId() + ".common.result.ResultCode;\n" +
    ...
    ASSERT_UTILS("utils", "Assert.java", "%s\n\n" +
            "import " + PomResolver.getInstance().getGroupId() + ".common.exception.AssertException;\n" +
            "import " + PomResolver.getInstance().getGroupId() + ".common.result.ResultCode;\n" +
